...
#python main.py --base configs/autoencoder/womac4x3disc.yaml -t --gpus 0,1,2,3 --logdir /home/ubuntu/Data/ldmlogs

python main.py --base configs/latent-diffusion/womac4x3dict.yaml -t --gpus 1,